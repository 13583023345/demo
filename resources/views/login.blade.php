...
<div class="wrapper">
            ...
            <ul>
                <li class="accAndPwd">
                    <dl>
                        ...
                        <cite class="passport_set" style=""></cite>
                    </dl>
                    <dl>
                        <input id="txtPassword" type="password" placeholder="密码" value="" maxlength="20" /><b></b>
                    </dl>
                    <dl>
                        <input id="img" type="text" placeholder="请输入验证码"  maxlength="4" /><b></b>
                        <img src="{{url('/login/Captcha')}}" alt="">
                    </dl>
                </li>
            </ul>
    ...
    <div class="oter_operation gray9" style="">
    ...
    $(function(){
        layui.use(['layer'], function () {
            ...
            $(".orangeBtn").click(function () {
                ...
                $.ajax({
                    type:"post",
                    data:{tel:tel,pwd:pwd,img:img,_token:'{{csrf_token()}}'},
                    url:"LoginDo",
                    success:function(res){
                        ...
                        if(res==1){
                            ...
                            layer.msg('登陆成功');
                            location.href="{{url('index/Shopcart')}}";
                        }
                    }
                })
            })
